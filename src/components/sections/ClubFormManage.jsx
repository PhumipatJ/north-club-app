      ...
      >
        ...
        <div className="flex flex-row items-center w-full gap-3 mb-4 justify-between ">
          <div className="flex flex-row gap-3 items-center w-[30%]">
            <h2 className="text-2xl font-bold " onClick={()=>console.log(prevform)}>เปิดรับสมัตรสมาชิก</h2>
          </div>
          <div
                ...
                <form className="flex flex-col">
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      type="text"
                      id="eventName"
                      placeholder= {prevFormCall.form_title}
                  ...
                  <div>
                    <label
                      ...
                      htmlFor="description"
                    >
                      <div className="flex items-end gap-3">ตำแหน่งที่เปิดรับ <p className="text-[#99a1af] text-[13px] font-medium">กรอก ตำแหน่ง ขั้นด้วย "," เสมอ</p></div>
                    </label>
                    <textarea
                      id="description"
                      placeholder={prevFormCall.role_available}
